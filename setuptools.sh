...
# copy tools
toollist="LogCMB teel teela eteela dama damaf edamaf rstama trbp rstspa rstdb ldb pldb getdb.py ldfrm audit aiaudit ccri ccru ccrt ngini nginu ngint ccre createdb stopall.sh keygen ckcip clrcip openrc closerc clrc genfrm refrc ckcus genBP genbpN genAuditBP updsql ckop mutemeas tl stbl"
